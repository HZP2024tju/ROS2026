...
class linuxRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type linuxRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type linuxRequest
    let len;
    let data = new linuxRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new linuxRequest(null);
...
class linuxResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type linuxResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type linuxResponse
    let len;
    let data = new linuxResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new linuxResponse(null);
...
module.exports = {
  ...
  md5sum() { return '4781436a0c2affec8025955a6041e481'; },
  datatype() { return 'phone/linux'; }
};
