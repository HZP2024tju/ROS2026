...
(cl:defmethod cl:initialize-instance :after ((m <person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name phone-msg:<person> is deprecated: use phone-msg:person instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader phone-msg:name-val is deprecated.  Use phone-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader phone-msg:age-val is deprecated.  Use phone-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'hight-val :lambda-list '(m))
(cl:defmethod hight-val ((m <person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader phone-msg:hight-val is deprecated.  Use phone-msg:hight instead.")
  (hight m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<person>)))
  ...
  "56af71e4d5123f01ffc8a50934f9ea28")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'person)))
  "Returns md5sum for a message object of type 'person"
  "56af71e4d5123f01ffc8a50934f9ea28")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<person>)))
  ...
  (cl:format cl:nil "string name~%int32 age~%float32 hight~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'person)))
  "Returns full string definition for message of type 'person"
  (cl:format cl:nil "string name~%int32 age~%float32 hight~%~%~%"))
