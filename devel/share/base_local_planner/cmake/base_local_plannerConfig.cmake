...
if("TRUE" STREQUAL "TRUE")
  set(base_local_planner_SOURCE_PREFIX /home/hzp/Ros2026/src/navigation/base_local_planner)
  set(base_local_planner_DEVEL_PREFIX /home/hzp/Ros2026/devel)
  ...
  set(base_local_planner_INSTALL_PREFIX /home/hzp/Ros2026/install)
...
if(NOT "/home/hzp/Ros2026/devel/include;/home/hzp/Ros2026/src/navigation/base_local_planner/include " STREQUAL " ")
  set(base_local_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/hzp/Ros2026/devel/include;/home/hzp/Ros2026/src/navigation/base_local_planner/include")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/base_local_planner " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Michael Ferguson <mfergs7@gmail.com>, David V. Lu!! <davidvlu@gmail.com>, Aaron Hoy <ahoy@fetchrobotics.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'base_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hzp/Ros2026/src/navigation/base_local_planner/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT base_local_planner_NUM_DUMMY_TARGETS)
      set(base_local_planner_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::base_local_planner::wrapped-linker-option${base_local_planner_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR base_local_planner_NUM_DUMMY_TARGETS "${base_local_planner_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::base_local_planner::wrapped-linker-option${base_local_planner_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND base_local_planner_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND base_local_planner_LIBRARIES ${library})
...
set(depends "angles;costmap_2d;dynamic_reconfigure;geometry_msgs;message_runtime;nav_core;nav_msgs;pluginlib;roscpp;sensor_msgs;std_msgs;tf2;tf2_ros;voxel_grid")
