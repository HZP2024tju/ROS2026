...
if("TRUE" STREQUAL "TRUE")
  set(amcl_SOURCE_PREFIX /home/hzp/Ros2026/src/navigation/amcl)
  set(amcl_DEVEL_PREFIX /home/hzp/Ros2026/devel)
  set(amcl_INSTALL_PREFIX "")
  set(amcl_PREFIX ${amcl_DEVEL_PREFIX})
else()
  set(amcl_SOURCE_PREFIX "")
  set(amcl_DEVEL_PREFIX "")
  set(amcl_INSTALL_PREFIX /home/hzp/Ros2026/install)
...
if(NOT "/home/hzp/Ros2026/devel/include;/home/hzp/Ros2026/src/navigation/amcl/include " STREQUAL " ")
  set(amcl_INCLUDE_DIRS "")
  set(_include_dirs "/home/hzp/Ros2026/devel/include;/home/hzp/Ros2026/src/navigation/amcl/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hzp/Ros2026/src/navigation/amcl/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT amcl_NUM_DUMMY_TARGETS)
      set(amcl_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::amcl::wrapped-linker-option${amcl_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR amcl_NUM_DUMMY_TARGETS "${amcl_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::amcl::wrapped-linker-option${amcl_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND amcl_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND amcl_LIBRARIES ${library})
