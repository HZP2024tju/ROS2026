...
if("TRUE" STREQUAL "TRUE")
  set(costmap_2d_SOURCE_PREFIX /home/hzp/Ros2026/src/navigation/costmap_2d)
  set(costmap_2d_DEVEL_PREFIX /home/hzp/Ros2026/devel)
  ...
  set(costmap_2d_INSTALL_PREFIX /home/hzp/Ros2026/install)
...
if(NOT "/home/hzp/Ros2026/devel/include;/home/hzp/Ros2026/src/navigation/costmap_2d/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(costmap_2d_INCLUDE_DIRS "")
  set(_include_dirs "/home/hzp/Ros2026/devel/include;/home/hzp/Ros2026/src/navigation/costmap_2d/include;/usr/include/eigen3;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'costmap_2d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hzp/Ros2026/src/navigation/costmap_2d/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT costmap_2d_NUM_DUMMY_TARGETS)
      set(costmap_2d_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::costmap_2d::wrapped-linker-option${costmap_2d_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR costmap_2d_NUM_DUMMY_TARGETS "${costmap_2d_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::costmap_2d::wrapped-linker-option${costmap_2d_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND costmap_2d_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND costmap_2d_LIBRARIES ${library})
...
set(depends "dynamic_reconfigure;geometry_msgs;laser_geometry;map_msgs;message_filters;message_runtime;nav_msgs;pluginlib;roscpp;sensor_msgs;std_msgs;tf2_ros;visualization_msgs;voxel_grid")
