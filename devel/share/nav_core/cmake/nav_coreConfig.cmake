...
if("TRUE" STREQUAL "TRUE")
  set(nav_core_SOURCE_PREFIX /home/hzp/Ros2026/src/navigation/nav_core)
  set(nav_core_DEVEL_PREFIX /home/hzp/Ros2026/devel)
  set(nav_core_INSTALL_PREFIX "")
  set(nav_core_PREFIX ${nav_core_DEVEL_PREFIX})
else()
  set(nav_core_SOURCE_PREFIX "")
  set(nav_core_DEVEL_PREFIX "")
  set(nav_core_INSTALL_PREFIX /home/hzp/Ros2026/install)
...
if(NOT "/home/hzp/Ros2026/src/navigation/nav_core/include " STREQUAL " ")
  set(nav_core_INCLUDE_DIRS "")
  set(_include_dirs "/home/hzp/Ros2026/src/navigation/nav_core/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nav_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hzp/Ros2026/src/navigation/nav_core/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT nav_core_NUM_DUMMY_TARGETS)
      set(nav_core_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::nav_core::wrapped-linker-option${nav_core_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR nav_core_NUM_DUMMY_TARGETS "${nav_core_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::nav_core::wrapped-linker-option${nav_core_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND nav_core_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND nav_core_LIBRARIES ${library})
...
set(depends "std_msgs;geometry_msgs;tf2_ros;costmap_2d")
