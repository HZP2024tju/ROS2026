...
if("TRUE" STREQUAL "TRUE")
  set(gmapping_SOURCE_PREFIX /home/hzp/Ros2026/src/slam_gmapping/gmapping)
  set(gmapping_DEVEL_PREFIX /home/hzp/Ros2026/devel)
  set(gmapping_INSTALL_PREFIX "")
  set(gmapping_PREFIX ${gmapping_DEVEL_PREFIX})
else()
  set(gmapping_SOURCE_PREFIX "")
  set(gmapping_DEVEL_PREFIX "")
  set(gmapping_INSTALL_PREFIX /home/hzp/Ros2026/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hzp/Ros2026/src/slam_gmapping/gmapping/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT gmapping_NUM_DUMMY_TARGETS)
      set(gmapping_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::gmapping::wrapped-linker-option${gmapping_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR gmapping_NUM_DUMMY_TARGETS "${gmapping_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::gmapping::wrapped-linker-option${gmapping_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND gmapping_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND gmapping_LIBRARIES ${library})
