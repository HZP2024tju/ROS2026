...
namespace costmap_2d
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(ObstaclePluginConfig &config, const ObstaclePluginConfig &max, const ObstaclePluginConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const ObstaclePluginConfig &config1, const ObstaclePluginConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, ObstaclePluginConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const ObstaclePluginConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, ObstaclePluginConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const ObstaclePluginConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const ObstaclePluginConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, ObstaclePluginConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(ObstaclePluginConfig::AbstractParamDescriptionConstPtr(new ObstaclePluginConfig::ParamDescription<int>("combination_method", "int", 0, "Method for combining two layers", "{'enum': [{'name': 'Overwrite', 'type': 'int', 'value': 0, 'srcline': 11, 'srcfile': '/home/hzp/Ros2026/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg', 'description': 'Overwrite values', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Maximum', 'type': 'int', 'value': 1, 'srcline': 12, 'srcfile': '/home/hzp/Ros2026/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg', 'description': 'Take the maximum of the values', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Nothing', 'type': 'int', 'value': 99, 'srcline': 13, 'srcfile': '/home/hzp/Ros2026/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg', 'description': 'Do nothing', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Method for combining layers enum'}", &ObstaclePluginConfig::combination_method)));
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 11 "/home/hzp/Ros2026/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg"
      const int ObstaclePlugin_Overwrite = 0;
//#line 12 "/home/hzp/Ros2026/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg"
      const int ObstaclePlugin_Maximum = 1;
//#line 13 "/home/hzp/Ros2026/src/navigation/costmap_2d/cfg/ObstaclePlugin.cfg"
