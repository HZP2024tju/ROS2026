...
struct GridMap_
{
  ...
  _layers_type layers;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _basic_layers_type;
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::grid_map_msgs::GridMap_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.layers.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.layers[i]);
    }
    if (v.layers.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "basic_layers: ";
    if (v.basic_layers.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.basic_layers.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.basic_layers[i]);
    }
    if (v.basic_layers.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.data.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::std_msgs::Float32MultiArray_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.data[i]);
    }
    if (v.data.empty() || false)
      s << "]";
    if (true || !indent.empty())
