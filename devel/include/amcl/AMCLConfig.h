...
namespace amcl
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(AMCLConfig &config, const AMCLConfig &max, const AMCLConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const AMCLConfig &config1, const AMCLConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, AMCLConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const AMCLConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, AMCLConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const AMCLConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const AMCLConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, AMCLConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.update_min_a = 6.283185307179586;
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.update_min_a = 0.5235987755982988;
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(AMCLConfig::AbstractParamDescriptionConstPtr(new AMCLConfig::ParamDescription<std::string>("laser_model_type", "str", 0, "Which model to use, either beam, likelihood_field or likelihood_field_prob.", "{'enum': [{'name': 'beam_const', 'type': 'str', 'value': 'beam', 'srcline': 54, 'srcfile': '/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use beam laser model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'likelihood_field_const', 'type': 'str', 'value': 'likelihood_field', 'srcline': 54, 'srcfile': '/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use likelihood_field laser model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'likelihood_field_prob', 'type': 'str', 'value': 'likelihood_field_prob', 'srcline': 54, 'srcfile': '/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use likelihood_field_prob laser model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Laser Models'}", &AMCLConfig::laser_model_type)));
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(AMCLConfig::AbstractParamDescriptionConstPtr(new AMCLConfig::ParamDescription<std::string>("laser_model_type", "str", 0, "Which model to use, either beam, likelihood_field or likelihood_field_prob.", "{'enum': [{'name': 'beam_const', 'type': 'str', 'value': 'beam', 'srcline': 54, 'srcfile': '/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use beam laser model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'likelihood_field_const', 'type': 'str', 'value': 'likelihood_field', 'srcline': 54, 'srcfile': '/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use likelihood_field laser model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'likelihood_field_prob', 'type': 'str', 'value': 'likelihood_field_prob', 'srcline': 54, 'srcfile': '/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use likelihood_field_prob laser model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Laser Models'}", &AMCLConfig::laser_model_type)));
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(AMCLConfig::AbstractParamDescriptionConstPtr(new AMCLConfig::ParamDescription<std::string>("odom_model_type", "str", 0, "Which model to use, diff, omni, diff-corrected, or omni-corrected", "{'enum': [{'name': 'diff_const', 'type': 'str', 'value': 'diff', 'srcline': 58, 'srcfile': '/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use diff odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'omni_const', 'type': 'str', 'value': 'omni', 'srcline': 59, 'srcfile': '/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use omni odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'diff_corrected_const', 'type': 'str', 'value': 'diff-corrected', 'srcline': 60, 'srcfile': '/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use corrected diff odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'omni_corrected_const', 'type': 'str', 'value': 'omni-corrected', 'srcline': 61, 'srcfile': '/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use corrected omni odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Odom Models'}", &AMCLConfig::odom_model_type)));
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(AMCLConfig::AbstractParamDescriptionConstPtr(new AMCLConfig::ParamDescription<std::string>("odom_model_type", "str", 0, "Which model to use, diff, omni, diff-corrected, or omni-corrected", "{'enum': [{'name': 'diff_const', 'type': 'str', 'value': 'diff', 'srcline': 58, 'srcfile': '/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use diff odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'omni_const', 'type': 'str', 'value': 'omni', 'srcline': 59, 'srcfile': '/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use omni odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'diff_corrected_const', 'type': 'str', 'value': 'diff-corrected', 'srcline': 60, 'srcfile': '/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use corrected diff odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'omni_corrected_const', 'type': 'str', 'value': 'omni-corrected', 'srcline': 61, 'srcfile': '/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use corrected omni odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Odom Models'}", &AMCLConfig::odom_model_type)));
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 54 "/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg"
...
//#line 58 "/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg"
      const char * const AMCL_diff_const = "diff";
//#line 59 "/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg"
      const char * const AMCL_omni_const = "omni";
//#line 60 "/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg"
      const char * const AMCL_diff_corrected_const = "diff-corrected";
//#line 61 "/home/hzp/Ros2026/src/navigation/amcl/cfg/AMCL.cfg"
